...
<%
	...
	// sDownloadPath가 물리적인 경로\\파일이름
	String sDownloadPath = context.getRealPath(savePath);
	// 폴더이름 + 파일이름
	String sFilePath = sDownloadPath + "\\" + fileName;

	byte b[] = new byte[4096];
	// 파일객체생성 파일정보 크기, 속성, 존재여부,... 파일정보를 확인할수있는 java api내장객체
	...
	// 서버 -> 클라이언트 설정 바꿈 => attachment 파일 첨부,다운하는걸로 바꿈
